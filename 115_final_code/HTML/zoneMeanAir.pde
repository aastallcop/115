...
float actual1, actual2, potential;
...
void importData() {
    String lines[] = loadStrings("zoneMeanAir.txt");
    actual1 = lines[1];
    actual2 = lines[2];
    potential = lines[3];
}
...
void drawFloor() {
    ...
    //openOffice
    fillGood = int(255 * (actual1/potential));
    fillBad = int(255 * (1 - actual1/potential));
    fill(fillBad, fillGood, 0);
    rect(openOfficeX, openOfficeY, openOfficeW, openOfficeH);
    fill(255, 255, 0);
    text ("Open Office", (openOfficeX + openOfficeW)/2, (openOfficeY + openOfficeH)/2, openOfficeW * 0.5, openOfficeH * 0.5);

    //lobby2
    fillGood = int(255 * (actual2/potential));
    fillBad = int(255 * (1 - actual2/potential));
    fill(fillBad, fillGood, 0);
    stroke(0);
    ...
    fill(255, 0, 255);
    text ("Lobby", lobby1X, lobby1Y, lobby1W, lobby1H);
    ...
    fill(255, 255, 0);
    text ("Staff Restoom", staffPeeX, staffPeeY, staffPeeW, staffPeeH);
    ...
    fill(255, 255, 0);
    text ("Office111", office111X, office111Y, office111W, office111H);
