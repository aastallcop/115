...
void importData() {
    String lines[] = loadStrings("pressure.txt");
    actual1 = lines[1];
    potential = lines[2];
}
...
void drawFloor() {
    ...
    fill(255, 255, 0);
    text ("Vestibule", vestX, vestY, vestW, vestH);
    ...
    fill(255, 255, 0);
    text ("Kitchen", kitchenX, kitchenY, kitchenW, kitchenH);
    ...
    fill(255, 255, 0);
    text ("Prep Room", prepX, prepY, prepW, prepH);
