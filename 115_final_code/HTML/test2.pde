...
void drawFloor() {
    ...
    //openOffice
    barGood = int(255 * (actual/potential));
    barBad = int(255 * (1 - actual/potential));
    ...
    int inc = stairsH/11;
    for(int i=0; i<11; i++) {
        int barGood2 = int(255 * (actual2/potential2));
        int barBad2 = int(255 * (1 - actual2/potential2));
        fill (barBad2, barGood2, 0);
